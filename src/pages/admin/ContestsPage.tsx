...
import { ContestCard, CreateContestForm, DeletedContestsList, useContests, useDeletedContests } from '@/features/contests';
...
export function ContestsPage() {
  ...
  const { data: deletedContests } = useDeletedContests();
  ...
  return (
    <div className="flex flex-1 flex-col justify-between gap-[160px]">
